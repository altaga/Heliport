...
class EthereumDeposit extends Component {
  constructor(props) {
    super(props);
    this.state = {};
    reactAutobind(this);
        ...
        <View style={GlobalStyles.container}>
          ...
          >
            ...
            <QRCodeStyled
              ...
              data={this.context.value.ethPublicKey}
              style={[
                {
            ...
            >
              ...
              >
                {this.context.value.ethPublicKey.substring(0, 21) +
                  "\n" +
                  this.context.value.ethPublicKey.substring(21)}
              </Text>
              <Pressable
                onPress={() => {
                  Clipboard.setString(this.context.value.ethPublicKey);
                  ToastAndroid.show(
...
export default EthereumDeposit;
